...
Route::get('/employees/edit/{id}', [EmployeeController::class,'employee_id'])->name('employees.show');
...
Route::get('/companies/edit/{id}', [CompanyController::class, 'company_id'])->name('');
